  ...
  render() {
    return (
        ...
        <form className='form-horizontal'>
            ...
            <Link  to='' onClick={this.props.router.goBack} className="btn-img" >
              ...
              <div className='admin-header col-sm-3'>
                  <button type=''
                       ...
                       onClick= {(e)=>{
                         e.preventDefault()
                         this.props.router.push('/add/STG')}}
            ...
            <SearchTable songs={this.state.searchValue? this.state.searchedSongs : this.state.songs} category="DEFINED" stg={true}/>
